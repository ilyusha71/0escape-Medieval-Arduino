...
/* Constant for Round Table Tag ID */
const int a = 147;
const int b = 27;
const int c = 214;
const int d = 211;
...
void setup() {
        ...
        Serial.println("Magic Altar & Prophet - Round Table 2016/04/23 iLYuSha Wakaka KocmocA");
...
void loop()
{ 
  if(mfrc522.uid.uidByte[0] == a && mfrc522.uid.uidByte[1] == b && mfrc522.uid.uidByte[2] == c && mfrc522.uid.uidByte[3] == d)
  ...
  mfrc522.uid.uidByte[0] = mfrc522.uid.uidByte[1] = mfrc522.uid.uidByte[2] = mfrc522.uid.uidByte[3] = -2;
