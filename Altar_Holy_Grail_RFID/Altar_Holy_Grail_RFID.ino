 ...
 * Project: 0escape Medieval - Altar - Holy Grail RFID
...
int escape = 0;
/* Constant for Tag ID */
int tagHolyGrail[4] = {249,22,186,13}; // F916BAD
/* Output */
...
void setup() 
{
  ...
  Serial.println("Magic Altar & Prophet - Holy Grail 2016/11/18 iLYuSha Wakaka KocmocA");
}
